...
4. Pegar la API Key personal de WeatherAPI en la variable 'weatherApiKey' de la constante 'environment' presente en el archivo src/app/environment.ts.
